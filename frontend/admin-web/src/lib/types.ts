...
export interface AgentTrace { id: string; session_id: string; turn_id: string; trace_id: string; node_name: string; sequence: number; duration_ms: number; is_success: boolean; routing_decision?: string | null; error_code?: string | null; llm_call?: Record<string, unknown> | null; tool_calls_summary?: Record<string, unknown>[] | null; created_at?: string; }
